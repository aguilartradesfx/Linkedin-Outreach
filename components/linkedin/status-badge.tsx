...
export const STATUS_CONFIG: Record<ProspectStatus, { label: string; className: string }> = {
  ...
  perfil_visitado:          { label: 'Perfil visitado',          className: 'bg-purple-500/15 text-purple-400' },
  ...
  mensaje_inicial_enviado:  { label: 'Mensaje inicial enviado',  className: 'bg-indigo-500/15 text-indigo-400' },
